...
\usepackage{hyperref}
\usepackage{xcolor}
% Добавляем ragged2e для \RaggedRight команды
\usepackage{ragged2e}
% Правильные кавычки, подстраивающиеся под язык документа
\usepackage{csquotes}
% Переносы
\usepackage{hyphenat}
...
% Определяем preprint как псевдоним для online типа
\DeclareBibliographyAlias{preprint}{online}
